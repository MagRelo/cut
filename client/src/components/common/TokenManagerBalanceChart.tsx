...
interface TokenManagerBalanceChartProps {
  className?: string;
  data?: Array<{
    timestamp: string;
    balance: number;
...
export const TokenManagerBalanceChart: React.FC<TokenManagerBalanceChartProps> = ({
  className = "",
  data,
  // title = "Token Manager Balance",
}) => {
  ...
  return (
    <div className={className}>
      ...
      <div
        className="bg-white border border-gray-100 p-4 pb-3 token-manager-chart"
        style={{ height: "200px" }}
      >
