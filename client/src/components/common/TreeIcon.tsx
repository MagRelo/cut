...
/** Phosphor Tree (regular), MIT https://phosphoricons.com */
export function TreeIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
      fill="currentColor"
      className={["text-green-700", className].filter(Boolean).join(" ")}
      {...props}
    >
