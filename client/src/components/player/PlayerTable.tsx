...
export const PlayerTable: React.FC<PlayerTableProps> = ({ players, roundDisplay }) => {
            ...
            return (
              <React.Fragment key={player.id}>
                <tr
                  ...
                  aria-label={expandedPlayers.has(player.id) ? "Hide scorecard" : "Show scorecard"}
                >
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900 flex items-center gap-2">
                          <span>
                            ...
                            {roundData?.icon && (
                              <span className="text-lg pl-2">{roundData.icon}</span>
                            )}
                          </span>
                          <svg
                  ...
                  <td className="w-12 py-2 pr-1 text-center text-sm text-gray-700">
                    {roundData?.holes?.scores
                      ? roundData.holes.scores.filter((score: number | null) => score !== null)
                          .length || "-"
                      : "-"}
                  </td>
                </tr>
