      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <p className="text-gray-600">Please log in to access user settings.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <>
      <div className="bg-white shadow rounded-lg p-4 mb-4">
        <h2 className="text-xl font-medium text-gray-900 mb-2">Notification Settings</h2>
        <NotificationSettings />
      </div>

      <div className="bg-white shadow rounded-lg p-4 mt-4">
        <div>
          <h2 className="text-xl font-medium text-gray-900 mb-2">Profile Information</h2>
        </div>
        <div className="space-y-4">
          {user.email && <div className="mt-1 text-gray-900">{user.email}</div>}
          {user.phone && <div className="mt-1 text-gray-900">{formatPhoneNumber(user.phone)}</div>}
        </div>
