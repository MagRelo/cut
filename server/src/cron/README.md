...
Operator runbooks: [`docs/event-activation-runbook.md`](../../../docs/event-activation-runbook.md) (golf) · [`docs/f1-event-activation-runbook.md`](../../../docs/f1-event-activation-runbook.md) (F1).
