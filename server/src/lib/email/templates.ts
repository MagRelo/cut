...
const HEADER_BRAND_COLOR = "#52525b";
...
function emailHeaderHtml(): string {
  ...
  <tr>
    ...
    <td valign="top" style="padding-top:${HEADER_TEXT_OPTICAL_ALIGN_TOP_PX}px;font-family:${FONT_DISPLAY};color:${HEADER_BRAND_COLOR};font-size:${HEADER_BRAND_SIZE_PX}px;font-weight:600;line-height:${HEADER_BRAND_SIZE_PX}px;white-space:nowrap;">
...
<body style="margin:0;padding:0;background:#f4f4f5;font-family:${FONT_BODY};">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f5;padding:24px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:8px;padding:32px 28px;">
          <tr>
