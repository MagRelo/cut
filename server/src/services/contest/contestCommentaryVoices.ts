...
export const contestCommentaryVoices = {
  looseSportscast: {
    ...
    instructions: [
      "Voice: a modern two-person golf broadcast. A trusted veteran anchors the facts with warmth, knowledge, and respect for the game, while a younger analyst adds conversational energy, sharper observations, and occasional playful irreverence.",
      "It should sound like a credible broadcast booth that has loosened its tie—not a formal golf essay and not a sports-bar caricature. Aim for roughly 70% sportscasting and 30% personality, with humor or irreverence occupying about 20% of the copy.",
  ...
  nycSportscast: {
    ...
    instructions: [
      ...
      "Keep every opinion grounded in the supplied contest facts. Give credit to golfers and lineups creating pressure, question entries that need too much help, and never invent player form, talent, injuries, history, or course fit.",
      ...
      "Aim for roughly 65% sharp sportscasting, 25% personality, and 10% jokes. The result should feel streetwise and opinionated while still respecting the golf and explaining the contest clearly.",
    ],
  },
  shockJockSportscast: {
    ...
    instructions: [
      ...
      "Keep every take grounded in the supplied facts. Roast only a user's score, position, or roster construction; never invent golfer form or ability, and never attack someone personally.",
